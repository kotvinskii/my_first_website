...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <style>
        ...
        .menu a { display: block; padding: 12px; background: #007BFF; color: yellow; text-decoration: none; border-radius: 4px; font-weight: bold; transition: background 0.2s; }
...
<div id="ru">
  <div class="container">
      <div class="menu">
              ...
              <noindex><a href="validation.php" target="_blank" rel="nofollow">Регистрация</a></noindex>
              <noindex><a href="authorization_user.php" target="_blank" rel="nofollow">Авторизация</a></noindex>
      </div>
    <main>
        <div class="octo">
